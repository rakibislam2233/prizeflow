  ...
  return (
    <section className="relative w-full h-full bg-[#f8f9ff] overflow-hidden flex items-center justify-center pt-20">
      <div className="container px-5 md:px-16 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 relative z-10 items-center h-full">
        ...
        >
          <div className="flex items-center flex-1 px-4 py-2.5 w-full border-b lg:border-b-0 lg:border-r border-[#D6DDEB] ">
          ...
          <div className="flex items-center flex-1 px-4 py-2.5 w-full cursor-pointer group border-b lg:border-b-0 border-[#D6DDEB] ">
          ...
          <Button className="w-full lg:w-[209px] lg:h-[57px] rounded-none bg-primary text-white px-8 py-6 text-base mt-2 lg:mt-0 transition-transform cursor-pointer ">
            Search my job
          </Button>
        </div>
        ...
        <div className="flex flex-col justify-center max-w-xl relative z-10 pt-10 pb-10 lg:pb-20">
          ...
          <p className="text-[#515B6F]  text-sm md:text-lg mb-8 lg:mb-12 mt-6 lg:mt-10 leading-relaxed">
          ...
          >
            <div className="flex items-center flex-1 lg:px-4 py-2 w-full border-b lg:border-b-0 lg:border-r border-[#D6DDEB] ">
              <Search className="text-gray-400 w-5 h-5 mr-3 shrink-0" />
              <Input
                type="text"
                placeholder="Job title or keyword"
            ...
            <div className="flex items-center flex-1 lg:px-4 py-2 w-full cursor-pointer group border-b lg:border-b-0 border-[#D6DDEB] ">
              <MapPin className="text-gray-400 w-5 h-5 mr-3 shrink-0" />
              <Input
                type="text"
                placeholder="Florence, Italy"
            ...
            <Button className="w-full lg:w-[209px] lg:h-[57px] rounded-none bg-primary hover:bg-[#3b36c0] text-white px-8 py-6 text-base mt-2 lg:mt-0 transition-all cursor-pointer font-bold ">
              Search my job
            </Button>
          </div>
