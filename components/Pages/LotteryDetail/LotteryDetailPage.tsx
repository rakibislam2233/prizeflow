            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg p-8">
                <div className="relative w-full h-[300px] flex flex-col items-center justify-center">
                  <h3
                    className={`font-bold text-center text-2xl mb-6 ${lottery.titleColor || "text-gray-800"}`}
                  >
                    {lottery.title}
                  </h3>
              ...
              <div className="bg-white rounded-lg p-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Enter for a chance to win {lottery.title}! This amazing prize
                  could be yours for just ${lottery.ticketPrice}. Our lottery
                  system is fair, transparent, and gives everyone an equal
                  chance to win. Don't miss this opportunity to change your life
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-600">
                      Purchase your lottery ticket for just $
                      {lottery.ticketPrice}
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-600">
                      Wait for the draw on {lottery.drawDate}
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-sm font-semibold shrink-0 mt-0.5">
                    ...
                    <p className="text-gray-600">
                      If your ticket is drawn, you win the {lottery.title}!
                    </p>
                  </div>
                </div>
              </div>
