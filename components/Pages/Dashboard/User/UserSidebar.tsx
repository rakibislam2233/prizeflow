...
const UserSidebar = ({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed md:sticky top-0 left-0 z-50 w-72 bg-[#F8F9FF] border-r border-gray-100 flex flex-col h-screen transition-transform duration-300 md:translate-x-0 ",
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-white text-primary ring-1 ring-gray-100"
