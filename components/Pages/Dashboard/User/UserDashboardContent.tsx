  ...
  return (
    <div className=" p-6 space-y-8">
      ...
      <div className="bg-white border border-gray-100 p-6 rounded-lg">
        <h3 className="text-lg font-bold text-[#25324B] mb-4">Storage Usage</h3>
        <div className="space-y-4">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div
              ...
              style={{
                width: `${Math.min(((stats?.storageUsed || 0) / 10) * 100, 100)}%`,
              }}
            ></div>
          </div>
          <p className="text-xs text-gray-500">
            {Math.max(0, 10 - (stats?.storageUsed || 0)).toFixed(1)} GB
            available
          </p>
        </div>
      </div>
      ...
      {/* Recent Files */}
      <div className="bg-white border border-gray-100 p-6 rounded-lg">
        <h3 className="text-lg font-bold text-[#25324B] mb-4">Recent Files</h3>
