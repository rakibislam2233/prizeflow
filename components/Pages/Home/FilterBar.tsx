      ...
      <div className="flex flex-wrap items-center justify-center gap-2 bg-white rounded-lg p-2 max-w-6xl mx-auto">
        {filters.map((filter, index) => (
          <motion.button
            ...
            className={`px-4 sm:px-6 md:px-8 lg:px-10 py-2 sm:py-3 text-xs sm:text-sm font-medium rounded transition-all duration-300 cursor-pointer whitespace-nowrap ${
              activeFilter === filter
