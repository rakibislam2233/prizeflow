    ...
    <DropdownMenu open={open} onOpenChange={setOpen}>
      <DropdownMenuTrigger asChild>
        <Button
          type="button"
          variant="outline"
          className="w-full justify-between h-12 rounded-none border-gray-200 focus-visible:ring-0 focus-visible:border-primary "
        >
      ...
      >
        ...
        {/* Library tabs */}
        <div className="flex gap-0 overflow-x-auto border-b border-gray-100 bg-gray-50 ">
          {TABS.map((tab) => (
            <button
              key={tab.id}
              type="button"
